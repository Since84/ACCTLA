		...
		<form id="posts-filter" action="" method="get">
			...
			<ul="widefat events-table">
					...
					foreach ( $EM_Events as $EM_Event ) {
						...
						?>
						<li class="event <?php echo trim($class); ?>" <?php echo $style; ?> id="event_<?php echo $EM_Event->event_id ?>">
							<?php /*
							<td>
							...
							*/ ?>
							<?php echo "whoo"; ?>
							<h1 class="event-name"><a class="row-title" href="<?php echo esc_url($EM_Event->get_edit_url()); ?>"><?php echo esc_html($EM_Event->event_name); ?></a><a href="<?php echo esc_url($EM_Event->get_edit_url()); ?>" class="register">Register Online</a></h1>
							<ul class="event-info">
								<li>
									<h2>When</h2>
							...
							<h2 class="event-details-head"></h2>
